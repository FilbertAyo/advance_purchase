        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="bg-primary d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.01s">
                        ...
                        <form method="POST" action="{{ url('/registration_form') }}">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="first_name" class="form-control border-0" placeholder="First Name" style="height: 55px;" required>
                                </div>
                                <!-- Last Name -->
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="last_name" class="form-control border-0" placeholder="Last Name" style="height: 55px;" required>
                                </div>
                                <!-- Phone -->
                                <div class="col-12 col-sm-6">
                                    <input type="tel" name="phone" class="form-control border-0" placeholder="Phone Number" style="height: 55px;" required>
                                </div>
                                <!-- User Type -->
                                <div class="col-12 col-sm-6">
                                ...
                                <!-- NIDA -->
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="nida" class="form-control border-0" placeholder="NIDA Number" style="height: 55px;" required>
                                </div>
                                <!-- Level -->
                                {{-- <div class="col-12 col-sm-6">
                                ...
                                <!-- Ward -->
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="ward" class="form-control border-0" placeholder="Ward" style="height: 55px;">
                                </div>
                                <!-- District -->
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="district" class="form-control border-0" placeholder="District" style="height: 55px;">
                                </div>
                                <!-- Street -->
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="street" class="form-control border-0" placeholder="Street" style="height: 55px;">
                                </div>
                                <!-- City -->
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="city" class="form-control border-0" placeholder="City" style="height: 55px;">
                                </div>
                                <!-- Gender -->
                                <div class="col-12 col-sm-6">
                                ...
                                <!-- Occupation -->
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="occupation" class="form-control border-0" placeholder="Occupation" style="height: 55px;">
                                </div>
                                <!-- Email -->
                                {{-- <div class="col-12">
                                ...
                                <div class="col-12 col-sm-6">
                                    <input type="password" id="password" name="password" class="form-control border-0" placeholder="Password" style="height: 55px;">
                                    <x-input-error :messages="$errors->get('password')" class="mt-2" />
                                </div>
                                <!-- City -->
                                <div class="col-12 col-sm-6">
                                    <input type="password" id="password_confirmation" name="password_confirmation" class="form-control border-0" placeholder="Repeat Your password" style="height: 55px;">
                                ...
                                <div class="form-row" style="display: none;">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                        name="status"  value="inactive" required>
                                    </div>
                                </div>
