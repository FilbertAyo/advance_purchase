                    ...
                    <form method="POST" action="{{ url('/registration_form') }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-sm-6">
                                <input type="text" name="first_name" class="form-control border-0" placeholder="@lang('messages.first_name')"
                                    value="{{ old('first_name') }}" style="height: 55px;" required>
                            </div>
                            <div class="col-12 col-sm-6">
                                <input type="text" name="middle_name" class="form-control border-0" placeholder="@lang('messages.middle_name')"
                                    value="{{ old('middle_name') }}" style="height: 55px;">
                            </div>
                            <!-- Last Name -->
                            <div class="col-12 col-sm-6">
                                <input type="text" name="last_name" class="form-control border-0" placeholder="@lang('messages.last_name')"
                                    value="{{ old('last_name') }}" style="height: 55px;" required>
                            </div>
                            <!-- Phone -->
                            <div class="col-12 col-sm-6">
                                <input type="tel" name="phone" class="form-control border-0" placeholder="@lang('messages.phone_number')"
                                    value="{{ old('phone') }}" style="height: 55px;" required>
                                    <x-input-error :messages="$errors->get('phone')" class="mt-2" />
                            </div>
                            <!-- Email -->
                            <div class="col-12 col-sm-6">
                                <input type="email" name="email" class="form-control border-0" placeholder="@lang('messages.email')"
                            ...
                            <div class="col-12 col-sm-6">
                                <input type="text" name="street" class="form-control border-0" value="{{ old('street') }}"
                                    placeholder="@lang('messages.street')" style="height: 55px;">
                            </div>
                            ...
                            <div class="col-12 col-sm-6" id="birth_date">
                                <input type="text" name="birth_date" id="birth_date_input" class="form-control border-0" style="height: 55px;" placeholder="@lang('messages.date_of_birth')" onfocus="this.type='date'" onblur="if(!this.value) this.type='text'">
                            </div>
                            ...
                            <div class="col-12 col-sm-6 position-relative">
                                <input type="password" id="password" name="password" class="form-control border-0"
                                    value="{{ old('password') }}" placeholder="@lang('messages.password')" style="height: 55px;">
